...
import { DartScoreHistory } from '@/components/game/dart-score-history';
...
export default function HistoryGamePage({params,}: { params: Promise<{ id: string }>}) {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <h1 className="text-3xl font-bold mb-6">Game Review</h1>
      <DartScoreHistory
